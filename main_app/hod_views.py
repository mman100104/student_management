...
from .utils_charts import generate_bar_chart, generate_pie_chart
from .forms import *
from .models import *
...
def admin_home(request):
    ...
    if subject_list:  # Chỉ tạo nếu có dữ liệu
        bar_chart_image = generate_bar_chart(
            labels=subject_list,
            values=attendance_counts,
            title="Số buổi tham dự theo môn học",
            xlabel="Môn học",
            ylabel="Số buổi"
        )
        ...
        pie_chart_image = generate_pie_chart(
            ...
            values=[total_students, total_staff],
            title="Phân bố Sinh viên và Giáo viên"
        )
